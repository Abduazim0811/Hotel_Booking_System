...
type HotelServiceClient interface {
	...
	GetAllHotels(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListHotels, error)
	...
	GetAllRooms(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListRooms, error)
...
func (c *hotelServiceClient) GetAllHotels(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListHotels, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListHotels)
...
func (c *hotelServiceClient) GetAllRooms(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListRooms, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRooms)
...
type HotelServiceServer interface {
	...
	GetAllHotels(context.Context, *Empty) (*ListHotels, error)
	...
	GetAllRooms(context.Context, *Empty) (*ListRooms, error)
...
func (UnimplementedHotelServiceServer) GetAllHotels(context.Context, *Empty) (*ListHotels, error) {
...
func (UnimplementedHotelServiceServer) GetAllRooms(context.Context, *Empty) (*ListRooms, error) {
...
func _HotelService_GetAllHotels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HotelServiceServer).GetAllHotels(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HotelService_GetAllRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HotelServiceServer).GetAllRooms(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
